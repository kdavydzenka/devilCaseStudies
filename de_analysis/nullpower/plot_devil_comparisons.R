...
method_cellwise_supp = MY_PALETTE %>% names()
method_patientwise_supp = MY_PALETTE %>% names()
method_cellwise_main = MY_PALETTE %>% names()
method_patientwise_main = MY_PALETTE %>% names()
